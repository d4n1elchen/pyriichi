...
- Impact: The suite covers most rules, but several documented rules are either untested or only weakly tested: direct response-priority conflicts, riichi stick payment, kyoutaku carry, Daisuushi pao settlement, and tobi through normal win settlement.
