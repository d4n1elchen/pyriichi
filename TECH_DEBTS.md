...
- Impact: The suite covers most rules, but several documented rules are either untested or only weakly tested: open Chanta/Junchan han reductions, disabled or alternate ruleset flags, direct response-priority conflicts, riichi stick payment, kyoutaku carry, Daisuushi pao settlement, and tobi through normal win settlement.
