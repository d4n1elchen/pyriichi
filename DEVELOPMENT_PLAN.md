...
### 階段 4：役種（Yaku）判定系統（🟡 部分完成，37/40+ 役種）
...
#### 4.5 役滿實現
- [ ] 天和、地和、人和 - 未實現（需要遊戲狀態追蹤）
- [x] 大三元、小四喜、大四喜
- [x] 四暗刻、四暗刻單騎 - 四暗刻已實現
- [x] 四槓子
- [x] 九蓮寶燈、純正九蓮寶燈
- [x] 國士無雙、國士無雙十三面 - 國士無雙已實現，十三面待完善
- [x] 綠一色、清老頭、字一色
- [ ] 四歸一 - 未實現
...
- [x] 翻數計算（han 字段累加）
- [x] 役種衝突檢測 - 部分實現（七對子、國士無雙特殊處理）
- [ ] 完整的役種衝突檢測 - 待完善（需要實現更嚴格的衝突規則）

**當前實現的衝突處理**：
- ✅ 七對子：不能與其他役種複合（除了立直）
- ✅ 國士無雙：不能與其他役種複合（除了立直）
- ✅ 役滿：不與非役滿役種複合（除了立直）
- ⚠️ 平和與役牌：需要檢查（目前可能未完全實現）
- ⚠️ 斷么九與包含幺九的役種：需要檢查（目前可能未完全實現）
- ⚠️ 對對和與需要順子的役種：需要檢查（目前可能未完全實現）
- ⚠️ 一盃口與二盃口：需要檢查（目前可能未完全實現）
- ⚠️ 清一色與混一色：需要檢查（目前可能未完全實現）
- ⚠️ 純全帶与混全帶：需要檢查（目前可能未完全實現）
...
**交付物**：
- [x] `yaku.py` - 役種判定系統
- [x] `test_yaku.py` - 單元測試（27個測試用例，涵蓋37個役種）
...
- 役滿（10個）：大三元、四暗刻、國士無雙、小四喜、大四喜、清老頭、字一色、四槓子、綠一色、九蓮寶燈
...
#### 7.1 測試完善
- [x] 單元測試基礎框架（57個測試用例全部通過）
  - [x] test_hand.py（9個測試）
  - [x] test_yaku.py（27個測試）
...
2. ✅ 能夠正確判定至少 20 個役種（當前：37個，已達成目標）
3. ✅ 能夠正確計算得分（符數、翻數、點數）
4. ✅ 能夠完成一局完整的遊戲流程（基本流程已實現）
5. ⚠️ 單元測試覆蓋率 > 80%（57個測試用例，覆蓋率待測量）
...
- [x] 門清自摸（1翻）- 已完成
- [x] 大部分役滿（10個役滿）- 已完成
- [ ] 天和、地和、人和（需要遊戲狀態追蹤）- 待實現
- [ ] 四歸一（役滿）- 待實現
- [ ] 國士無雙十三面（需要更精確的判定）- 待完善
- [ ] 自風判定（需完善玩家位置邏輯）- 待實現
